...
//      this.logger.error(e.getMessage(), e);
//    }
    //return new EcardCheckinBuilder().build("",wxMessage,null);
    return new TextBuilder().build("你好呀！我是电小科Bot，可以查询一卡通余额，消费，充值情况，图书借阅历史呢", wxMessage, weixinService);
  }
  ...
  protected WxMpXmlOutMessage handleSpecial(WxMpXmlMessage wxMessage) throws Exception {
    ...
    //return null;
    //return new EcardCheckinBuilder().build("",wxMessage,null);
    return new TextBuilder().build("你好呀！我是电小科Bot，可以查询一卡通余额，消费，充值情况，图书借阅历史呢", wxMessage, null);
  }
